...
public class FileValidation {
	...
	static boolean DataLength(String spincode, byte length)
	{
	...
	static boolean Mandatory(String [] s)
	{
		boolean b;
	...
	static boolean DomainValue(char c, List<Character> values)
	{
		boolean b=false;
	...
	static boolean CustomerNameValidation(String name)
	{
		boolean b1=true;
